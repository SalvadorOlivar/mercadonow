...
Todavía no existe un flujo ejecutable por HTTP ni persistencia conectada a la
API. `BillingModule` está registrado, pero sus capas `application`,
`infrastructure` y `presentation` aún no están cableadas.

## Orden de ejecución recomendado

### Etapa 1 — Crear órdenes en la capa de aplicación

1. **#22 — Implement CreateOrder use case**
...
5. **#23 — Implement CreatePayment use case**
...
6. **#24 — Implement CreateInvoice use case**
...
7. **#25 — Implement GetInvoice use case**
...
- **UC-003 Process Payment:** #23 se llama `CreatePayment`; hay que aclarar si
  también procesa el pago o si `ProcessPayment` será una operación separada.
